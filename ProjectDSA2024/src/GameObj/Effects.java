...
public class Effects {
    ...
    private ModelGoBoom[] booms;
    private float alpha = 1f;

    public Effects(double x, double y, int totalEffect, int max_size, double max_distance, float speed, Color color) {
        this.x = x;
        this.y = y;
    ...
    private void randomCreation() {
        booms = new ModelGoBoom[totalEffect];
        ...
        for (int i = 1; i <= totalEffect; i++) {
            ...
            float angle = i * per + r;
            booms[i - 1] = new ModelGoBoom(boomSize, angle);
        }
    }

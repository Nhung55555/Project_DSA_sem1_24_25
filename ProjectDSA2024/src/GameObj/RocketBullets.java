...
public class RocketBullets {
    ...
    public RocketBullets(double x, double y, float angle, double size, float speed){
        x += Rocket.ROCKET_SIZE / 2 - (size/2);
        y += Rocket.ROCKET_SIZE/2 - (size/2);
        this.x = x;
        this.y = y;
        this.angle = angle;
        this.size = size;
